...
namespace Banking_project {
    ...
    public partial class BankingDataSet : global::System.Data.DataSet {
        ...
        private global::System.Data.DataRelation relationFK__Employee__440B1D61;
        
        private global::System.Data.DataRelation relationFK__Employee__Branch__44FF419A;
        ...
        internal void InitVars(bool initTable) {
            ...
            this.relationFK__Employee__440B1D61 = this.Relations["FK__Employee__440B1D61"];
            this.relationFK__Employee__Branch__44FF419A = this.Relations["FK__Employee__Branch__44FF419A"];
        ...
        private void InitClass() {
            ...
            this.relationFK__Employee__440B1D61 = new global::System.Data.DataRelation("FK__Employee__440B1D61", new global::System.Data.DataColumn[] {
                        this.tableUser_.passwordColumn,
                        this.tableUser_.emailColumn}, new global::System.Data.DataColumn[] {
                        this.tableEmployee.passwordColumn,
                        this.tableEmployee.emailColumn}, false);
            this.Relations.Add(this.relationFK__Employee__440B1D61);
            this.relationFK__Employee__Branch__44FF419A = new global::System.Data.DataRelation("FK__Employee__Branch__44FF419A", new global::System.Data.DataColumn[] {
                        this.tableBranch.Branch_NumberColumn}, new global::System.Data.DataColumn[] {
                        this.tableEmployee.Branch_NumberColumn}, false);
            this.Relations.Add(this.relationFK__Employee__Branch__44FF419A);
        ...
        public partial class EmployeeDataTable : global::System.Data.TypedTableBase<EmployeeRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public EmployeeRow AddEmployeeRow(string id, string Address, string phone, string Name, string password, string email, BranchRow parentBranchRowByFK__Employee__Branch__44FF419A) {
                ...
                object[] columnValuesArray = new object[] {
                        ...
                        email,
                        null};
                if ((parentBranchRowByFK__Employee__Branch__44FF419A != null)) {
                    columnValuesArray[6] = parentBranchRowByFK__Employee__Branch__44FF419A[1];
                }
        ...
        public partial class LoanDataTable : global::System.Data.TypedTableBase<LoanRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public LoanRow AddLoanRow(int loan_num, double loan_amount, string laon_type, CustomerRow parentCustomerRowByFK__Loan__Cus_SSN__33D4B598, BranchRow parentBranchRowByFK__Loan__Branch_Num__34C8D9D1, string Status, string Employee_id) {
        ...
        public partial class BranchRow : global::System.Data.DataRow {
            ...
            public EmployeeRow[] GetEmployeeRows() {
                if ((this.Table.ChildRelations["FK__Employee__Branch__44FF419A"] == null)) {
                    return new EmployeeRow[0];
                }
                else {
                    return ((EmployeeRow[])(base.GetChildRows(this.Table.ChildRelations["FK__Employee__Branch__44FF419A"])));
                }
            }
        ...
        public partial class EmployeeRow : global::System.Data.DataRow {
            ...
            public User_Row User_RowParent {
                get {
                    return ((User_Row)(this.GetParentRow(this.Table.ParentRelations["FK__Employee__440B1D61"])));
                }
                set {
                    this.SetParentRow(value, this.Table.ParentRelations["FK__Employee__440B1D61"]);
                }
            }
            ...
            public BranchRow BranchRow {
                get {
                    return ((BranchRow)(this.GetParentRow(this.Table.ParentRelations["FK__Employee__Branch__44FF419A"])));
                }
                set {
                    this.SetParentRow(value, this.Table.ParentRelations["FK__Employee__Branch__44FF419A"]);
                }
            }
        }
        ...
        public partial class User_Row : global::System.Data.DataRow {
            ...
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public EmployeeRow[] GetEmployeeRows() {
                if ((this.Table.ChildRelations["FK__Employee__440B1D61"] == null)) {
                    return new EmployeeRow[0];
                }
                else {
                    return ((EmployeeRow[])(base.GetChildRows(this.Table.ChildRelations["FK__Employee__440B1D61"])));
                }
            }
        }
...
namespace Banking_project.BankingDataSetTableAdapters {
...
SELECT account_number, account_type, Balance, Cus_SSN FROM Account WHERE (account_number = @account_number)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Banking_project.Properties.Settings.Default.BankingConnectionString;
        }
...
SELECT id, Address, phone, Name, password, email, Branch_Number FROM Employee WHERE (id = @id)";
    ...
    public partial class LoanTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.DeleteCommand.Connection = this.Connection;
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Loan] WHERE (([loan_num] = @Original_loan_num) AND ([loan_amount] = @Original_loan_amount) AND ([laon_type] = @Original_laon_type) AND ([Cus_SSN] = @Original_Cus_SSN) AND ([Branch_Number] = @Original_Branch_Number) AND ((@IsNull_Status = 1 AND [Status] IS NULL) OR ([Status] = @Original_Status)) AND ((@IsNull_Employee_id = 1 AND [Employee_id] IS NULL) OR ([Employee_id] = @Original_Employee_id)))";
            this._adapter.DeleteCommand.CommandType = global::System.Data.CommandType.Text;
            ...
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Loan] ([loan_num], [loan_amount], [laon_type], [Cus_SSN], [Branch_Number], [Status], [Employee_id]) VALUES (@loan_num, @loan_amount, @laon_type, @Cus_SSN, @Branch_Number, @Status, @Employee_id);
SELECT loan_num, loan_amount, laon_type, Cus_SSN, Branch_Number, Status, Employee_id FROM Loan WHERE (loan_num = @loan_num)";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            ...
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Loan] SET [loan_num] = @loan_num, [loan_amount] = @loan_amount, [laon_type] = @laon_type, [Cus_SSN] = @Cus_SSN, [Branch_Number] = @Branch_Number, [Status] = @Status, [Employee_id] = @Employee_id WHERE (([loan_num] = @Original_loan_num) AND ([loan_amount] = @Original_loan_amount) AND ([laon_type] = @Original_laon_type) AND ([Cus_SSN] = @Original_Cus_SSN) AND ([Branch_Number] = @Original_Branch_Number) AND ((@IsNull_Status = 1 AND [Status] IS NULL) OR ([Status] = @Original_Status)) AND ((@IsNull_Employee_id = 1 AND [Employee_id] IS NULL) OR ([Employee_id] = @Original_Employee_id)));
SELECT loan_num, loan_amount, laon_type, Cus_SSN, Branch_Number, Status, Employee_id FROM Loan WHERE (loan_num = @loan_num)";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT loan_num, loan_amount, laon_type, Cus_SSN, Branch_Number, Status, Employee" +
                "_id FROM dbo.Loan";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Delete, true)]
        public virtual int Delete(int Original_loan_num, double Original_loan_amount, string Original_laon_type, int Original_Cus_SSN, int Original_Branch_Number, string Original_Status, string Original_Employee_id) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Insert, true)]
        public virtual int Insert(int loan_num, double loan_amount, string laon_type, int Cus_SSN, int Branch_Number, string Status, string Employee_id) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(int loan_num, double loan_amount, string laon_type, int Cus_SSN, int Branch_Number, string Status, string Employee_id, int Original_loan_num, double Original_loan_amount, string Original_laon_type, int Original_Cus_SSN, int Original_Branch_Number, string Original_Status, string Original_Employee_id) {
            ...
            if ((Original_Employee_id == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[15].Value = ((string)(Original_Employee_id));
            }
            global::System.Data.ConnectionState previousConnectionState = this.Adapter.UpdateCommand.Connection.State;
            if (((this.Adapter.UpdateCommand.Connection.State & global::System.Data.ConnectionState.Open) 
                        != global::System.Data.ConnectionState.Open)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(double loan_amount, string laon_type, int Cus_SSN, int Branch_Number, string Status, string Employee_id, int Original_loan_num, double Original_loan_amount, string Original_laon_type, int Original_Cus_SSN, int Original_Branch_Number, string Original_Status, string Original_Employee_id) {
            return this.Update(Original_loan_num, loan_amount, laon_type, Cus_SSN, Branch_Number, Status, Employee_id, Original_loan_num, Original_loan_amount, Original_laon_type, Original_Cus_SSN, Original_Branch_Number, Original_Status, Original_Employee_id);
        }
    }
